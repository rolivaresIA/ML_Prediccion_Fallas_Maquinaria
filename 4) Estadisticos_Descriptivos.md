...
```
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## decal_model_nm      n   missing   distinct 
    ##                  28967     0         63  
    ## ----------------------------------------------------------------------------------------------------------
    ## alert_level         n   missing   distinct 
    ##                  28967     0          4 
    ##                                  
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## alert_defn_dsc      n   missing   distinct 
    ##                  28967     0         2541                                                              
    ## ----------------------------------------------------------------------------------------------------------
    ## pin_prefix          n   missing   distinct 
    ##                  28967     0          7   
    ##                                            
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## prod_line_nm        n   missing   distinct 
    ##                  28967     0         13   
    ##      
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## tla                 n   missing   distinct 
    ##                  28967     0         56   
    ##        
    ## lowest : ACL ACR ADU ALC ALS, highest: VCU VPC VSS WAB WAC
    ## ----------------------------------------------------------------------------------------------------------
    ## first_cptr_tm       n   missing   distinct    Info       Mean     pMedian    Gmd 
    ##                  28967     0        366         1     2020-06-24   18438    125.9
    ## ----------------------------------------------------------------------------------------------------------
    ## native_pin          n   missing   distinct 
    ##                  28967     0        1234 
    ## ----------------------------------------------------------------------------------------------------------
    ## first_dtc_engn_hours   n  missing  distinct    Info     Mean  pMedian      Gmd 
    ##                     28967      0    18793        1      5261    4920      4637        
    ## ----------------------------------------------------------------------------------------------------------
    ## sum_ocr_cnt            n  missing  distinct     Info     Mean  pMedian      Gmd 
    ##                     28967      0      969      0.951    66.59    5.5      122.2 
    ##
    ## lowest :     1     2     3     4     5, highest: 15686 15916 16228 17141 17690
    ## ----------------------------------------------------------------------------------------------------------
    ## tipo_maquina_nivel_2   n  missing distinct 
    ##                     28967      0       2  
    ##                                           
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## MFG_DT              n    missing   distinct       Info       Mean    pMedian        Gmd        .05        .10 
    ##                   28967          0        646          1 2017-01-02      17240      843.6 2012-06-07 2014-01-01 
    ##                  .25        .50        .75        .90        .95        
    ## ----------------------------------------------------------------------------------------------------------
    ## año_facturacion     n     missing  distinct 
    ##                   28967      0        10 
    ##                                                                       
    ...
    ## ----------------------------------------------------------------------------------------------------------
    ## mantencion_previa   n  missing distinct 
    ##                   28967   0        2 
    ##                       
    ## Value         No    Si
